                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(color: Color(0x96387AF6),width: 2),
                        borderRadius: BorderRadius.circular(5)
                      ),
                      child: Icon(Icons.add,color: Color(0x96387AF6)),
                    ),
                  ),
                ),
              ]),
    ...
    return Container(
      ...
      child: Row(children: [
        Stack(children: [
          ClipRRect(
            borderRadius: BorderRadius.circular(5),
            child: Image.asset(appointmentModel.imageUrl, height: 50, width: 50, fit: BoxFit.cover),
          ),
          Positioned(
            bottom: 0,
            right: 0,
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(5),
                color: appointmentModel.callType == 'Messaging' ? ColorResources.COLOR_YELLOW_SEA : appointmentModel.callType == 'Video Call' ? ColorResources.COLOR_MAYA_BLUE : ColorResources.COLOR_PRIMARY,
              ),
              child: Icon(
                appointmentModel.callType == 'Messaging' ? Icons.message : appointmentModel.callType == 'Video Call' ? Icons.video_call : Icons.call,
                color: Colors.white,
                size: 10,
              ),
            ),
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(appointmentModel.callType, style: khulaRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: ColorResources.COLOR_GREY)),
          Text(appointmentModel.name, style: khulaRegular.copyWith(fontSize: 20, color: ColorResources.COLOR_PRIMARY)),
          Text(appointmentModel.time, style: khulaRegular.copyWith(fontSize: Dimensions.FONT_SIZE_EXTRA_SMALL, color: ColorResources.COLOR_GREY)),
        ]),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: appointmentModel.isAccept ? ColorResources.COLOR_MAYA_BLUE : ColorResources.COLOR_YELLOW_SEA,
          ),
          child: Text(
            appointmentModel.isAccept ? Strings.ACCEPTED : Strings.DECLINED,
            style: khulaRegular.copyWith(color: ColorResources.COLOR_WHITE, fontSize: 8),
          ),
        ),
      ]),
    );
