                                ...
                                Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: Icon(Icons.person, size: 30, color: ColorResources.COLOR_WHITE),
                                    ),
                                    Text(Strings.NAME1,style: khulaRegular.copyWith(color: ColorResources.COLOR_GREY, fontSize: 10)),
                                  ],
                                ),
                                SizedBox(width: 15),
                                Expanded(
