      ...
      child: Column(
        ...
        children: [
          NotificationItem(
              ...
              title: "You have an appointment now !!",
              content:
                  "Click here to join the chat and start your appointment"),
          Divider(height: 10, color: ColorResources.COLOR_GREY),
          NotificationItem(
              imageUrl: 'assets/doctor/Icon/time 2.png',
              title: Strings.APPOINTMENT_REMINDER,
              content: Strings.LOREM__ALIQUA),
          Divider(height: 10, color: ColorResources.COLOR_GREY),
          NotificationItem(
              imageUrl: 'assets/doctor/Icon/payment blue.png',
